...
export default {
  ...
  props: {
    list1: { type: Array, default: () => [] },
    list2: { type: Array, default: () => [] },
    list1Title: { type: String, default: 'list1' },
    list2Title: { type: String, default: 'list2' },
    width1: { type: String, default: '48%' },
    width2: { type: String, default: '48%' }
  },
  methods: {
    isNotInList1(v) {
