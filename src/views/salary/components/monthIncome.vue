<template>
  <el-table :key="2" :data="tableData" show-summary border fit highlight-current-row @selection-change="onSelectionChange" @row-dblclick="onAloneDblclick">
    <template slot="empty">
...
// settings
export default {
  name: 'SalaryComponentsMonthIncome',
  components: {},
  mixins: [TableMixin],
  props: {
