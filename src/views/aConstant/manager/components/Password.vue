    ...
    >
      <el-row>
        <el-col>
          <el-form-item
            prop="passwordOld"
            :label="`旧${fields.password}`"
            :label-width="labelWidth"
          >
            <el-input
              ref="passwordOld"
              v-model.trim="postForm.passwordOld"
      ...
      <el-row>
        <el-col>
          <el-form-item
            prop="passwordNew"
            :label="`新${fields.password}`"
            :label-width="labelWidth"
          >
            <el-input
              ref="passwordNew"
              v-model.trim="postForm.passwordNew"
      ...
      <el-row>
        <el-col>
          <el-form-item
            prop="passwordRep"
            :label="`确认${fields.password}`"
            :label-width="labelWidth"
          >
            <el-input
              ref="passwordRep"
              v-model.trim="postForm.passwordRep"
        ...
        this.$refs.postForm.validate((valid, fields) => {
          if (valid) {
            if (this.postForm.passwordOld === this.postForm.passwordNew) {
              ...
              this.postForm.passwordNew !== this.postForm.passwordRep
            ) {
